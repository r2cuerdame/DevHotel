...
const api: IpcApi = {
  rooms: {
    ...
    safeResyncFromHost: (roomId, approvedHostPath, confirmDiscardRoomChanges) =>
      ipcRenderer.invoke(IPC.roomsSafeResyncFromHost, roomId, approvedHostPath, confirmDiscardRoomChanges),
